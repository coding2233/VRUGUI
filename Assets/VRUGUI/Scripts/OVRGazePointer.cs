...
public class OVRGazePointer : MonoBehaviour {
    ...
    public OVRCameraRigInfor cameraRig;
	...
	void Update () {
        ...
        transform.position = cameraRig.RayAnchor.transform.position + cameraRig.RayAnchor.transform.forward * depth;
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        depth = (cameraRig.RayAnchor.transform.position - pos).magnitude;
    ...
    {
        SetPosition(pos, cameraRig.RayAnchor.transform.forward);
    }
    ...
    void LateUpdate()
    {
        ...
        if (positionSetsThisFrame == 0)
        {
            ...
            Quaternion newRot = transform.rotation;
            newRot.SetLookRotation(cameraRig.RayAnchor.transform.forward, (lastPosition - transform.position).normalized);
            transform.rotation = newRot;
        }
