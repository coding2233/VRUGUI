...
namespace UnityEngine.EventSystems
{
    public class OVRInputModule : PointerInputModule
    {
        ...
        public SteamVR_Controller.Device _RightDevice;
      ...
      //  [Tooltip("Gamepad button to act as gaze click")]
       // public SteamVR_Controller.ButtonMask joyPadClickButton = OVRInput.Button.One;
...
#region PointerEventData pool
        ...
        protected PointerEventData.FramePressState GetGazeButtonState()
        {
            ...
            var pressed = Input.GetKeyDown(gazeClickKey) || _RightDevice.GetPressDown(SteamVR_Controller.ButtonMask.Trigger);
            var released = Input.GetKeyUp(gazeClickKey) || _RightDevice.GetPressUp(SteamVR_Controller.ButtonMask.Trigger);
#else
            var pressed = Input.GetKeyDown(gazeClickKey) || OVRInput.GetDown(OVRInput.Button.One);
            var released = Input.GetKeyUp(gazeClickKey) || OVRInput.GetUp(OVRInput.Button.One);
#endif
